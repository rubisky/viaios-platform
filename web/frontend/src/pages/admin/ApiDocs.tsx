...
const ENDPOINTS: ApiEndpoint[] = [
  ...
  { method: 'GET', path: '/api/v1/agents', module: 'Agent', description: 'Agent list', status: 'active' },
  { method: 'POST', path: '/api/v1/agents/plan', module: 'Agent', description: 'AI task planning', status: 'active' },
  { method: 'POST', path: '/api/v1/agents/search', module: 'Agent', description: 'Intelligent search', status: 'active' },
  { method: 'POST', path: '/api/v1/agents/llm/chat', module: 'Agent', description: 'LLM chat', status: 'active' },
  { method: 'POST', path: '/api/v1/agents/orchestrate', module: 'Agent', description: 'Multi-agent orchestration', status: 'active' },
  { method: 'POST', path: '/api/v1/agents/memory/remember', module: 'Agent', description: 'Memory storage', status: 'active' },
  { method: 'POST', path: '/api/v1/agents/memory/recall', module: 'Agent', description: 'Memory retrieval', status: 'active' },
...
const ApiDocs: React.FC = () => {
  ...
  const columns = [
    ...
    { title: 'Status', dataIndex: 'status', width: 70, render: () => <CheckCircleOutlined style={{ color: '#52c41a' }} /> },
  ];
